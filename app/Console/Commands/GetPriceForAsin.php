...
use App\Jobs\GetMyPriceForASIN;
use App\SellerAccounts;
class GetPriceForAsin extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:price {--sellerId=}';
    ...
    public function handle()
    {
		...
		$sellerAccounts->chunk(10,function($sellers){
            foreach ($sellers as $seller) {
				GetMyPriceForASIN::dispatch($seller)->onConnection('beanstalkd-shedule-get')->onQueue('beanstalkd-shedule-get');
            }
        });
